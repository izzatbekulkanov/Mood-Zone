    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published_city', models.CharField(help_text='Kitob nash qilingan shahar', max_length=255)),
                ...
                ('authors', models.ManyToManyField(help_text='Kitobning mualliflari', related_name='books', to='library.author')),
