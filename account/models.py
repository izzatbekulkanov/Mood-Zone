...
class CustomUser(AbstractUser):
    ...
    paymentForm = models.ForeignKey(PaymentForm, on_delete=models.CASCADE, verbose_name="To'lov turi", null=True, blank=True)
    studentType = models.ForeignKey(StudentType, on_delete=models.CASCADE, verbose_name="Talaba turi", null=True, blank=True)
    accommodation = models.ForeignKey(Accommodation, on_delete=models.CASCADE, verbose_name="Turar joyi", blank=True, null=True, )
    ...
    staffPosition = models.ForeignKey(StaffPosition, on_delete=models.CASCADE, verbose_name="Xodimo'rni", blank=True, null=True, related_name='staffposition')
