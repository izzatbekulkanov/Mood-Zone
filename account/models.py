...
class CustomUser(AbstractUser):
    ...
    university = models.ForeignKey(University, on_delete=models.CASCADE, verbose_name="Universitet", null=True,
                                   blank=True)
    ...
    citizenship = models.ForeignKey(Citizenship, on_delete=models.CASCADE, verbose_name="Fuqarolik", null=True,
                                    blank=True)
    studentStatus = models.ForeignKey(StudentStatus, on_delete=models.CASCADE, verbose_name="Talaba holati", null=True,
                                      blank=True)
    educationForm = models.ForeignKey(EducationForm, on_delete=models.CASCADE, verbose_name="Ta'lim shakli", null=True,
                                      blank=True)
    educationType = models.ForeignKey(EducationType, on_delete=models.CASCADE, verbose_name="Ta'lim turi", null=True,
                                      blank=True)
    paymentForm = models.ForeignKey(PaymentForm, on_delete=models.CASCADE, verbose_name="To'lov turi", null=True,
                                    blank=True)
    studentType = models.ForeignKey(StudentType, on_delete=models.CASCADE, verbose_name="Talaba turi", null=True,
                                    blank=True)
    accommodation = models.ForeignKey(Accommodation, on_delete=models.CASCADE, verbose_name="Turar joyi", blank=True,
                                      null=True, )
    department = models.ForeignKey(Department, on_delete=models.CASCADE, verbose_name="Fakultet", blank=True,
                                   null=True, )
    curriculum = models.ForeignKey(Curriculum, on_delete=models.CASCADE, verbose_name="O'quv rejasi", null=True,
                                   blank=True)

    specialty = models.ForeignKey(Specialty, on_delete=models.CASCADE, verbose_name="Mutaxassislik", null=True,
                                  blank=True)
    ...
    educationYear = models.ForeignKey(EducationYear, on_delete=models.CASCADE, verbose_name="O'quv yili", null=True,
                                      blank=True)
    ...
    employeeStatus = models.ForeignKey(EmployeeStatus, on_delete=models.CASCADE, verbose_name="Xodimholati", blank=True,
                                       null=True)
    user_type = models.CharField(_('Turi'), choices=type_choice, default="1", max_length=20, blank=True, null=True)
    employeeType = models.ForeignKey(EmployeeType, on_delete=models.CASCADE, verbose_name="Xodim turi", blank=True,
                                     null=True)
