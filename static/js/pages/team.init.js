...
function loadTeamData(datas) {
    ...
    Array.from(datas).forEach(function (teamData, index) {
        ...
        var isUserProfile = teamData.memberImg ? '<img static="'+teamData.memberImg+'" alt="" class="member-img img-fluid d-block rounded-circle" />'
        ...
        '<div class="col">\
            <div class="card team-box">\
                <div class="team-cover">\
                    <img static="'+teamData.coverImg+'" alt="" class="img-fluid" />\
                </div>\
