    ...
    getJSON("chat-users-list.json", function (err, data) {
        if (err !== null) {
            ...
            users.forEach(function (userData, index) {
                var isUserProfile = userData.profile ? '<img static="' + userData.profile + '" class="rounded-circle img-fluid userprofile" alt=""><span class="user-status"></span>'
            ...
            for (i = 0; i < has_images.length; i++) {
                ...
                <div>\
                    <a class="popup-img d-inline-block" href="' + has_images[i] + '">\
                        <img static="' + has_images[i] + '" alt="" class="rounded border">\
                    </a>\
                </div>\
            ...
            if (err !== null) {
                ...
                chatsData.forEach(function (isChat, index) {
                    ...
                    if (userChatId != isChat.from_id)
                        msgHTML += '<div class="chat-avatar"><img static="' + user.profile + '" alt=""></div>';
