...
xhttp.onload = function () {
    ...
    Array.from(json_records).forEach(function (raw){
        ...
        contactList.add({
            ...
            <div class="flex-shrink-0"><img static="'+raw.name[0]+'" alt="" class="avatar-xs rounded-circle"></div>\
        ...
        if (!form.checkValidity()) {
            ...
            if (customerNameField.value !== "" &&
                ...
                contactList.add({
                    ...
                    name: '<div class="d-flex align-items-center">\
                    <div class="flex-shrink-0"><img static="'+ customerImg.src + '" alt="" class="avatar-xs rounded-circle object-cover"></div>\
                ...
                Array.from(editValues).forEach(function (x) {
                    ...
                    if (selectedid == itemId) {
                        x.values({
                            ...
                            name: '<div class="d-flex align-items-center">\
                            <div class="flex-shrink-0"><img static="'+customerImg.src+'" alt="" class="avatar-xs rounded-circle object-fit-cover"></div>\
                            <div class="flex-grow-1 ms-2 name">'+customerNameField.value+'</div>\
                            </div>',
                            company_name: company_nameField.value,
                            designation: designationField.value,
