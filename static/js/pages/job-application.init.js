...
xhttp.onload = function () {
    ...
    Array.from(json_records).forEach(function(element){
        applicationList.add({
            ...
            <img static="'+element.company[0]+'" alt="" class="avatar-xxs rounded-circle image_src object-fit-cover">\
            </div>\
        ...
        if (!form.checkValidity()) {
            ...
            if (companyField.value !== "" &&
                ...
                applicationList.add({
                    ...
                    company: '<div class="d-flex align-items-center">\
                    <div class="flex-shrink-0">\
                        <img static="'+ companyLogoImg.src + '" alt="" class="avatar-xxs rounded-circle image_src object-fit-cover">\
                    </div>\
